...
namespace Rnet.Drivers
{
    ...
    /// object tree. They can thus be returned from multiple <see cref="IBusObjectContainer"/>s. A <see 
    ...
    public abstract class LogicalBusObject : RnetBusObject
    {
        ...
        protected LogicalBusObject(ContainerContext context)
            : base(context.Owner.Device.Bus)
        {
            Context.Set<ContainerContext>(context);
        }
